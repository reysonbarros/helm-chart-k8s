...
# Acessar o diretorio abaixo do projeto clonado
...
# Deploy do Helm Chart da aplicação
# giropops-senhas refere-se ao nome da release(qualquer nome que desejar informar)
# ./ refere-se ao caminho onde o Chart.yaml foi criado
...
# Empacota um diretorio do chart em um arquivo de chart no formato .tgz
helm package {path_from _chart}

# Cria um index com os repositorios do helm chart
helm repo index --url https://github.com/reysonbarros/helm-chart-k8s .

# Acessar o Settings do repo no github, realizar a config abaixo e clicar em Save
# Source: Deploy from a branch
# Branch: main root 
# Obs: Aguardar alguns isntantes e atualizar a página para exibir a url(subdomínio) criada pelo github

# Adicionando um repositorio helm
helm repo add giropops-senhas-github https://reysonbarros.github.io/helm-chart-k8s/

# Listando os repositorios helm
helm repo list

# Pesquisar um repositorio helm
